...
class Eliminating:
    ...
    def zhengjian_test(self, arr1, arr2, arr1_index):
        ...
        for i in range(k + 1, len(arr1), 1):
            if np.abs(interpolate.UnivariateSpline(csth, csnh, k=3, s=0)(arr1[i]) - arr2[i]) < self.lamda:
                result1[i] = 1
                del csth[0]
                del csnh[0]
                csth.append(arr1[i])
                csnh.append(arr2[i])
            elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=2, s=0)(arr1[i]) - arr2[i]) < self.lamda:
                result1[i] = 1
                del csth[0]
                del csnh[0]
                csth.append(arr1[i])
                csnh.append(arr2[i])
            elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=1, s=1)(arr1[i]) - arr2[i]) < self.lamda:
                result1[i] = 1
                del csth[0]
                del csnh[0]
                csth.append(arr1[i])
    ...
    def zhengjian(self, num2):
        if len(num2) == 0:
            ...
            for i in range(k + 1, len(self.arr1), 1):
                if np.abs(interpolate.UnivariateSpline(csth, csnh, k=3, s=0)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                    result1[i] = 1
                    del csth[0]
                    del csnh[0]
                    csth.append(self.arr1[i])
                    csnh.append(self.arr2[i])
                elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=2, s=0)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                    result1[i] = 1
                    del csth[0]
                    del csnh[0]
                    csth.append(self.arr1[i])
                    csnh.append(self.arr2[i])
                elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=1, s=1)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                    result1[i] = 1
                    del csth[0]
                    del csnh[0]
                    csth.append(self.arr1[i])
            ...
            for i in range(len(num2)-1):
                ...
                for j in range(k + 1, len(arr_1), 1):
                    if np.abs(interpolate.UnivariateSpline(csth, csnh, k=3, s=0)(arr_1[j]) - arr_2[j]) < self.lamda:
                        result1[j] = 1
                        del csth[0]
                        del csnh[0]
                        csth.append(arr_1[j])
                        csnh.append(arr_2[j])
                    elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=2, s=0)(arr_1[j]) - arr_2[j]) < self.lamda:
                        result1[j] = 1
                        del csth[0]
                        del csnh[0]
                        csth.append(arr_1[j])
                        csnh.append(arr_2[j])
                    elif np.abs(interpolate.UnivariateSpline(csth, csnh, k=1, s=1)(arr_1[j]) - arr_2[j]) < self.lamda:
                        result1[j] = 1
                        del csth[0]
                        del csnh[0]
                        csth.append(arr_1[j])
    ...
    def pro_test(self, result3):
        ...
        for i in idx[0]:
            ...
            if np.abs(interpolate.UnivariateSpline(list3, list4, k=3, s=0)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                result3[i] = 1
            elif np.abs(interpolate.UnivariateSpline(list3, list4, k=2, s=0)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                result3[i] = 1
            elif np.abs(interpolate.UnivariateSpline(list3, list4, k=1, s=1)(self.arr1[i]) - self.arr2[i]) < self.lamda:
                result3[i] = 1
            else:
                result3[i] = 0
        return result3
